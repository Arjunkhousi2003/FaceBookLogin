...
public class PayUPaymentActivity extends AppCompatActivity {
    ...
    //String base_url="https://secure.payu.in";// for live 
    int error=0;
    String hashString="";
    ...
    static String getChargeAmt,getFirstName="User",getNumber="7042143686",getEmailAddress="raj.shiladitya@gmail.com";
...
/*
      ...
      //  getChargeAmt = oIntent.getExtras().getString("CHARGE_AMT");
        ...
        mapParams.put("hash",PayUPaymentActivity.this.hash);
        mapParams.put("txnid",(empty(PayUPaymentActivity.this.params.get("txnid"))) ? "" : PayUPaymentActivity.this.params.get("txnid"));
        Log.d(tag, "txnid: "+PayUPaymentActivity.this.params.get("txnid"));
        mapParams.put("service_provider","payu_paisa");

        mapParams.put("amount",(empty(PayUPaymentActivity.this.params.get("amount"))) ? "" : PayUPaymentActivity.this.params.get("amount"));
        mapParams.put("firstname",(empty(PayUPaymentActivity.this.params.get("firstname"))) ? "" : PayUPaymentActivity.this.params.get("firstname"));
        mapParams.put("email",(empty(PayUPaymentActivity.this.params.get("email"))) ? "" : PayUPaymentActivity.this.params.get("email"));
        mapParams.put("phone",(empty(PayUPaymentActivity.this.params.get("phone"))) ? "" : PayUPaymentActivity.this.params.get("phone"));

        mapParams.put("productinfo",(empty(PayUPaymentActivity.this.params.get("productinfo"))) ? "" : PayUPaymentActivity.this.params.get("productinfo"));
        mapParams.put("surl",(empty(PayUPaymentActivity.this.params.get("surl"))) ? "" : PayUPaymentActivity.this.params.get("surl"));
        mapParams.put("furl",(empty(PayUPaymentActivity.this.params.get("furl"))) ? "" : PayUPaymentActivity.this.params.get("furl"));
        mapParams.put("lastname",(empty(PayUPaymentActivity.this.params.get("lastname"))) ? "" : PayUPaymentActivity.this.params.get("lastname"));

        mapParams.put("address1",(empty(PayUPaymentActivity.this.params.get("address1"))) ? "" : PayUPaymentActivity.this.params.get("address1"));
        mapParams.put("address2",(empty(PayUPaymentActivity.this.params.get("address2"))) ? "" : PayUPaymentActivity.this.params.get("address2"));
        mapParams.put("city",(empty(PayUPaymentActivity.this.params.get("city"))) ? "" : PayUPaymentActivity.this.params.get("city"));
        mapParams.put("state",(empty(PayUPaymentActivity.this.params.get("state"))) ? "" : PayUPaymentActivity.this.params.get("state"));

        mapParams.put("country",(empty(PayUPaymentActivity.this.params.get("country"))) ? "" : PayUPaymentActivity.this.params.get("country"));
        mapParams.put("zipcode",(empty(PayUPaymentActivity.this.params.get("zipcode"))) ? "" : PayUPaymentActivity.this.params.get("zipcode"));
        mapParams.put("udf1",(empty(PayUPaymentActivity.this.params.get("udf1"))) ? "" : PayUPaymentActivity.this.params.get("udf1"));
        mapParams.put("udf2",(empty(PayUPaymentActivity.this.params.get("udf2"))) ? "" : PayUPaymentActivity.this.params.get("udf2"));

        mapParams.put("udf3",(empty(PayUPaymentActivity.this.params.get("udf3"))) ? "" : PayUPaymentActivity.this.params.get("udf3"));
        mapParams.put("udf4",(empty(PayUPaymentActivity.this.params.get("udf4"))) ? "" : PayUPaymentActivity.this.params.get("udf4"));
        mapParams.put("udf5",(empty(PayUPaymentActivity.this.params.get("udf5"))) ? "" : PayUPaymentActivity.this.params.get("udf5"));
        mapParams.put("pg",(empty(PayUPaymentActivity.this.params.get("pg"))) ? "" : PayUPaymentActivity.this.params.get("pg"));
    ...
    /*class PostRechargeData extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... args)
        {
            ...
            String rechargeAmt = getChargeAmt;
            String postAction = "1";

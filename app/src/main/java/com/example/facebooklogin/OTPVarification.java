...
public class OTPVarification extends AppCompatActivity {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent i = new Intent(OTPVarification.this, Fetch_images.
                            ...
                            Toast.makeText(OTPVarification.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
    }
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            ...
            Toast.makeText(OTPVarification.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    };
